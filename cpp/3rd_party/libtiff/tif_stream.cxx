...
extern "C" {
	...
	static int 	_tiffDummyMapProc(thandle_t , const void** base, toff_t* size );
	static void     _tiffDummyUnmapProc(thandle_t , const void* base, toff_t size );
...
static int
_tiffDummyMapProc(thandle_t , const void** base, toff_t* size )
{
	(void) base;
	(void) size;
	return (0);
...
static void
_tiffDummyUnmapProc(thandle_t , const void* base, toff_t size )
{
	(void) base;
	(void) size;
}
