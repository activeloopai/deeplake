 ...
 * Columns are considered to be identical if they have the same column name, dtype, htype and dimensionality of samples.
 *
 ...
 */
heimdall::column_view_ptr create_merged_column(heimdall::column_view_ptr t1, heimdall::column_view_ptr t2);
}
