...
For video compressions, we only support already compressed data read using dl.read. We do not actually compress the video data. 

Also, when using dl.read with one of the video compressions, ensure that the compression matches, otherwise hub will be unable to compress the data to the specified compression.
