    ...
    def __init__(self, data):
        for key, value in data.items():
            if isinstance(value, dict):
                ...
                setattr(self, key, [ontology_for_debug(item) if isinstance(item, dict) else item for item in value])
            else:
...
def ontology_for_debug_from_json(projects, project_id):
    ...
    def parse_classification_(classification):
        ...
        if 'radio_answer' in classification:
            ...
            option = {
                ...
                'feature_schema_id': classification['radio_answer']['feature_schema_id']
            }
        ...
        if 'checkbox_answers' in classification:
            ...
            option = {
                ...
                'feature_schema_id': classification['checkbox_answers']['feature_schema_id']
            }
    ...
    return ontology_for_debug({"classifications": final_classifications, "tools": final_tools})
