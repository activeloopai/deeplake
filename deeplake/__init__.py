...
from .util.bugout_reporter import dl_reporter
...
dl_reporter.tags.append(f"version:{__version__}")
dl_reporter.system_report(publish=True)
dl_reporter.setup_excepthook(publish=True)
