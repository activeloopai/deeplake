...
def read(
    ...
    Examples:
        ...
        >>> ds.images.append(dl.read("path/to/cat.jpg"))
        >>> ds.images.shape
        (1, 399, 640, 3)

        >>> ds.create_tensor("videos", htype="video", sample_compression="mp4")
        >>> ds.videos.append(dl.read("path/to/video.mp4"))
        >>> ds.videos.shape
        (1, 136, 720, 1080, 3)

        >>> ds.create_tensor("images", htype="image", sample_compression="jpeg")
        >>> ds.images.append(dl.read("https://picsum.photos/200/300"))
        >>> ds.images[0].shape
        (300, 200, 3)
    ...
    Note:
        ...
        This is useful for passing along to :func:`Tensor.append <dl.core.tensor.Tensor.append>` and :func:`Tensor.extend <dl.core.tensor.Tensor.extend>`.
    """
