...
class dataset:
    ...
    def copy(
        ...
        Args:
            ...
            token (str, optional): Activeloop token, used for fetching credentials to the datasets if it is a Deep Lake dataset. This is optional, tokens are normally autogenerated.
