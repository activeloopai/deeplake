...
class ViewEntry:
    ...
    def load(self, verbose=True):
        """Loads the view and returns the :class:`~dl.core.dataset.Dataset`.
    ...
    def optimize(
        ...
        Args:
            unlink (bool): - If ``True``, this unlinks linked tensors (if any) by copying data from the links to the view.
                    - This does not apply to linked videos. Set ``dl.constants._UNLINK_VIDEOS`` to ``True`` to change this behavior.
