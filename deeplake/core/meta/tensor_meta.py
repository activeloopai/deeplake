    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            **kwargs: Any key that the provided `htype` has can be overridden via **kwargs. For more information, check out `dl.htype`.
        """
...
def _validate_required_htype_overwrites(htype: str, htype_overwrite: dict):
    ...
    if sample_compression not in dl.compressions:
    ...
    if chunk_compression not in dl.compressions:
