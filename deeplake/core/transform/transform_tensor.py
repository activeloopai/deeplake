...
class TransformTensor:
    ...
    def numpy(self) -> None:
        """Returns all the items stored in the slice of the tensor as numpy arrays. Even samples stored using dl.read are converted to numpy arrays in this."""
    ...
    def numpy_compressed(self):
        """Returns all the items stored in the slice of the tensor. Samples stored using dl.read are not converted to numpy arrays in this."""
        value = self.items
