...
class Tensor:
    ...
    def extend(
        ...
        Args:
            ...
            verify (bool): Whether to verify links. Only applicable for link tensors.
        Raises:
    ...
    @invalid_view_op
    def append(self, sample: InputSample, verify: bool = True):
        ...
        Args:
            ...
            verify (bool): Whether links should be verified. Only applicable for link tensors.
        """
        self.extend([sample], progressbar=False, verify=verify)
