...
>>> ds.image_seq.append([dl.read("img01.jpg"), dl.read("img02.jpg")])
...
>>> ds.img.append(dl.link("s3://abc/def.jpeg", creds_key="MY_S3_KEY"))
>>> ds.img.append(dl.link("gcs://ghi/jkl.png", creds_key="GCS_KEY"))
>>> ds.img.append(dl.link("https://picsum.photos/200/300")) # http path doesn’t need creds
>>> ds.img.append(dl.link("./path/to/cat.jpeg")) # local path doesn’t need creds
>>> ds.img.append(dl.link("s3://abc/def.jpeg"))  # this will throw an exception as cloud paths always need creds_key
>>> ds.img.append(dl.link("s3://abc/def.jpeg", creds_key="ENV"))  # this will use creds from environment
...
>>> ds.img[0] = dl.link("./data/cat.jpeg")
