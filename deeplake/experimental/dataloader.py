...
class Hub3DataLoader:
    ...
    def batch(self, batch_size: int, drop_last: bool = False):
        """Returns a batched dl.experimental.Hub3DataLoader object.
    ...
    def shuffle(self):
        """Returns a shuffled dl.experimental.Hub3DataLoader object.
    ...
    def transform(self, transform: Union[Callable, Dict[str, Optional[Callable]]]):
        """Returns a transformed dl.experimental.Hub3DataLoader object.
    ...
    def query(self, query_string: str):
        """Returns a sliced dl.experimental.Hub3DataLoader object with given query results.
    ...
    def pytorch(
        ...
        """Returns a dl.experimental.Hub3DataLoader object.
...
def dataloader(dataset) -> Hub3DataLoader:
    """Returns a dl.experimental.Hub3DataLoader object which can be transformed to either pytorch dataloader or numpy.


    Args:
        dataset: dl.Dataset object on which dataloader needs to be built
    ...
    Examples:
        ...
        >>> ds = dl.load('hub://activeloop/coco-train')
