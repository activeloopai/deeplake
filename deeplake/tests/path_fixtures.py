...
_HUB_TEST_RESOURCES_URL = "https://www.gitdl.com/activeloopai/hub-test-resources.git"
_PILLOW_URL = "https://www.gitdl.com/python-pillow/Pillow.git"
...
def hub_cloud_path(request, hub_cloud_dev_token):
    ...
    if not is_opt_true(request, KEEP_STORAGE_OPT):
        try:
            dl.delete(path, force=True, large_ok=True, token=hub_cloud_dev_token)
        except Exception:
