...
the performance impact is minimal. Note: Using the outputs of this function with .pytorch method of dataset (instead of .dataloader) may result in poor performance.
