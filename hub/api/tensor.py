...
class Tensor:
    ...
    def extend(self, array: Union[np.ndarray, Sequence[np.ndarray]]):
        ...
        # TODO: rename `array` to `samples` + update docstring to mention `SymbolicSample`
    ...
    def append(
        self,
        sample: Union[np.ndarray, float, int, SymbolicSample],
    ):
        ...
        Args:
            sample (np.ndarray, float, int, SymbolicSample): The data to append to the tensor. `SymbolicSample` is generated by `hub.load`. See the above examples.
        """
