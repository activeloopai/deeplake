...
class Dataset:
    def __init__(
        ...
        like: Optional[Union[str, "Dataset"]] = None,
        like_creds: Optional[dict] = None,
    ):
        ...
        Args:
            ...
            like (str/Dataset, optional): The full path for the datasets or Dataset object. If provided, will create a new Dataset with the same tesnors and metas.
    ...
    def _like_ds(self, like: Union[str, "Dataset"], like_creds: dict = None):
