...
class Dataset:
    ...
    def pytorch(
        ...
        """
        return dataset_to_pytorch(self, transform, num_workers=num_workers, tensors=tensors, batch_size=batch_size, drop_last=drop_last, collate_fn=collate_fn, pin_memory=pin_memory)
