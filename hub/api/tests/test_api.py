...
from hub.tests.storage_fixtures import enabled_persistent_storages
...
def test_hub_remote_read(storage, memory_ds, video_paths, color_image_paths):
    ...
    storage["test_image/jpg/sample/samplejpg.jpg"] = byts
    image = hub.read(
        f"{storage.root}/test_image/jpg/sample/samplejpg.jpg"
    )
    memory_ds.images.append(image)
