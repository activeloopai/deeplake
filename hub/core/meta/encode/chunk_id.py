...
class ChunkIdEncoder(Cachable):
    def __init__(self):
        ...
        Chunk IDs:
            Chunk IDs are a uint64 value (64-bits) and this class handles generating/encoding them.
    ...
    def __getitem__(
        ...
        Returns:
            Tuple[Tuple[np.uint64], Optional[Tuple[int]]]: Returns the chunk ID for `sample_index`. If `return_chunk_index` is True,
