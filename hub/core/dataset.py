...
class Dataset:
    def __init__(
        ...
        self._set_derived_attributes(allow_path_not_empty=allow_path_not_empty)
    ...
    def _load_meta(self, allow_path_not_empty: bool = False):
    ...
    def _set_derived_attributes(self, allow_path_not_empty: bool = False):
