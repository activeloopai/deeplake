...
class S3Provider(StorageProvider):
    ...
    def __init__(
        ...
        Args:
            ...
            config (botocore.config.Config, optional): Config object to use for the constructed client.
        """
        self.root = root
        ...
        self.client_config = config or botocore.config.Config(max_pool_connections=50)
