...
class Tensor:
    ...
    @invalid_view_op
    def append(self, sample: InputSample, progressbar=False):
        ...
        Args:
            ...
            progressbar (bool): Specifies whether a progressbar should be displayed while appending.
        """
        self.extend([sample], progressbar)
