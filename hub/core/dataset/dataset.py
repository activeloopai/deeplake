...
class Dataset:
    ...
    def save_view(
        ...
        **ds_args,
        ...
        Args:
            path (Optional, str): If specified, the VDS will saved as a standalone dataset at the specified path. If not,
    ...
    def _get_empty_vds(
        ...
        Args:
            vds_path (Optional, str): If specified, the vds will be saved at this path. Else the vds will be saved
    ...
    def copy(
        ...
        Args:
            dest: Destination dataset or path to copy to. If a Dataset instance is provided, it is expected to be empty.
