...
class Dataset:
    ...
    def pytorch(
        ...
        Args:
            ...
            buffer_size (int): The size of the buffer used to shuffle the data in number of samples. Defaults to 2048 samples. Increasing the buffer_size will increase the extent of shuffling.
