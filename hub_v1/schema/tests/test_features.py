...
from hub_v1.schema.class_label import ClassLabel, _load_names_from_file
from hub_v1.schema.features import HubSchema, SchemaDict, Tensor
import pytest
...
def test_class_label():
    ...
    cl5 = ClassLabel()
    cl6 = ClassLabel(names_file="./hub_v1/schema/tests/class_label_names.txt")
