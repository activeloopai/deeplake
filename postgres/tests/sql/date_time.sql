...
DO $$ BEGIN
    ...
    PERFORM assert_query_row_count(1, 'SELECT * FROM people WHERE birth_date = ''2001-02-02''');
    PERFORM assert_query_row_count(1, 'SELECT * FROM people WHERE birth_time = ''09:30:00''');
    PERFORM assert_query_row_count(1, 'SELECT * FROM people WHERE created_at = ''2021-02-02 11:30:00''');
    PERFORM assert_query_row_count(1, 'SELECT * FROM people WHERE created_at_tz = ''2021-02-02 11:30:00+01''');

    -- Test date/time comparison operators 
    PERFORM assert_query_row_count(5, 'SELECT * FROM people WHERE birth_date > ''2002-01-01''');
    PERFORM assert_query_row_count(2, 'SELECT * FROM people WHERE birth_time < ''10:00:00''');
    PERFORM assert_query_row_count(5, 'SELECT * FROM people WHERE created_at >= ''2022-01-01 00:00:00''');
    PERFORM assert_query_row_count(6, 'SELECT * FROM people WHERE created_at_tz <= ''2024-12-31 23:59:59+00''');
    ...
    PERFORM assert_table_row_count(10007, 'people');
