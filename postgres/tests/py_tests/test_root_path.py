...
@pytest.mark.asyncio
async def test_root_path_basic(db_conn: asyncpg.Connection):
    """
...
@pytest.mark.asyncio
async def test_root_path_explicit_override(db_conn: asyncpg.Connection):
    """
...
@pytest.mark.asyncio
async def test_root_path_multiple_tables(db_conn: asyncpg.Connection):
    """
