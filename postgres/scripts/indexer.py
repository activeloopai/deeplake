...
# Indexer v.1.0.1 (modified to remove Size column)
# Author: Josh Brunty (josh dot brunty at marshall dot edu)
# Modified by: [Your Name]
# DESCRIPTION: This script generates an .html index of files within a directory,
# but the Size column has been removed from the output.
...
def process_dir(top_dir, opts):
    ...
    # Write HTML header without the Size column.
    index_file.write(
        """<!DOCTYPE html>
<html>
<head>
...
<div class="listing">
    <table aria-describedby="summary">
        ...
        <tr class="clickable">
            <td></td>
            <td><a href=".."><svg width="1.5em" height="1em" version="1.1" viewBox="0 0 24 24">
                <use xlink:href="#go-up"></use></svg>
...
"""
    ...
    """
            ...
            <tr class="file">
                <td></td>
                <td>
                    <a href="{quote(entry_path)}" download="{entry_path}">
                        <svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path opacity="0.5" d="M3 15C3 17.8284 3 19.2426 3.87868 20.1213C4.75736 21 6.17157 21 9 21H15C17.8284 21 19.2426 21 20.1213 20.1213C21 19.2426 21 17.8284 21 15" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
...
# bytes pretty-printing (no longer used in output, but retained for potential future use)
UNITS_MAPPING = [
    (1024**5, " PB"),
    (1024**4, " TB"),
    (1024**3, " GB"),
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="""DESCRIPTION: This script generates an .html index of files within a directory (recursive is OFF by default).
Start from current dir or from folder passed as first positional argument. Optionally filter by file types with --filter "*.py"
Email josh dot brunty at marshall dot edu for additional help."""
    ...
    parser.add_argument(
        ...
        nargs="?",
        action="store",
        help="top folder from which to start generating indexes, use current folder if not specified",
        default=os.getcwd(),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        "-v",
        action="store_true",
        help="***WARNING: can take longer time with complex file tree structures on slow terminals*** verbosely list every processed file",
        required=False,
    )
